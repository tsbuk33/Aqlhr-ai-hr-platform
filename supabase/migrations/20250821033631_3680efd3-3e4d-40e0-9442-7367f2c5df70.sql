-- Employee Master Data v1: Storage, Events, and RLS (Fixed)
...
CREATE INDEX IF NOT EXISTS idx_docs_events_employee_company 
ON public.docs_events (employee_id, company_id);

CREATE INDEX IF NOT EXISTS idx_docs_events_company_created 
ON public.docs_events (company_id, created_at DESC);