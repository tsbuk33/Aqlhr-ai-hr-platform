-- TASK 3C: ANALYTICS & AI MODULE DATA (Fixed Model Types)
...
BEGIN
    ...
    -- AI PREDICTIONS DATA with correct model types
    INSERT INTO public.ai_predictions (
        ...
        (company_uuid, emp_ids[1], 'performance_trend', 0.95, 'low', 
        ...
        (company_uuid, emp_ids[2], 'attrition_risk', 0.12, 'low', 
         jsonb_build_object('engagement_score', 0.85, 'career_progression', 0.92, 'compensation_satisfaction', 0.87),
         jsonb_build_object('lower', 0.08, 'upper', 0.18), CURRENT_DATE, CURRENT_DATE + 90),
        
        (company_uuid, emp_ids[3], 'training_impact', 0.92, 'low', 
        ...
        (company_uuid, emp_ids[5], 'burnout_risk', 0.25, 'low', 
