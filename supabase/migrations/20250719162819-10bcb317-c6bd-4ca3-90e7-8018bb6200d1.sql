-- COMPREHENSIVE EMPLOYEE AND MODULE DATA POPULATION
-- Phase 1: Core Employee Data Enhancement
...
BEGIN
    ...
    -- INSERT COMPREHENSIVE EMPLOYEE DATA with all fields
    INSERT INTO public.employees (
        ...
        hire_date, status, gender, job_level, experience_years, performance_score,
        ...
        (emp_id_1, company_uuid, 'AQL001', 'Ahmed', 'Al-Rashid', 'أحمد', 'الراشد',
         ...
         50000, 0, 0, '2020-01-15', 'active', 'male', 'Executive', 12, 98,
        ...
        (emp_id_2, company_uuid, 'AQL002', 'Fatima', 'Al-Zahra', 'فاطمة', 'الزهراء',
         ...
         35000, 25, 10, '2020-03-20', 'active', 'female', 'Executive', 10, 95,
        ...
        (emp_id_3, company_uuid, 'AQL003', 'Mohammed', 'Al-Otaibi', 'محمد', 'العتيبي',
         ...
         45000, 20, 8, '2019-09-10', 'active', 'male', 'Executive', 15, 97,
        ...
        (emp_id_4, company_uuid, 'AQL004', 'Sarah', 'Al-Mansouri', 'سارة', 'المنصوري',
         ...
         25000, 25, 10, '2021-02-01', 'active', 'female', 'Senior', 8, 88,
        ...
        (emp_id_5, company_uuid, 'AQL005', 'Omar', 'Al-Ghamdi', 'عمر', 'الغامدي',
         ...
         28000, 20, 10, '2020-09-15', 'active', 'male', 'Senior', 9, 92,
         false, false, true, false, 25, true,
        ...
        (emp_id_6, company_uuid, 'AQL006', 'Aisha', 'Khan', 'عائشة', 'خان',
         ...
         15000, 25, 10, '2022-08-01', 'active', 'female', 'Senior', 6, 87,
         false, false, true, true, 25, false,
        ...
        (emp_id_7, company_uuid, 'AQL007', 'Ravi', 'Sharma', 'رافي', 'شارما',
         ...
         22000, 25, 10, '2021-11-15', 'active', 'male', 'Senior', 7, 89,
         false, false, true, false, 25, true,
        ...
        (emp_id_8, company_uuid, 'AQL008', 'Noor', 'Al-Harbi', 'نور', 'الحربي',
         ...
         12000, 25, 10, '2023-01-10', 'active', 'female', 'Mid-Level', 3, 82,
        ...
        (emp_id_9, company_uuid, 'AQL009', 'Khalid', 'Al-Dosari', 'خالد', 'الدوسري',
         ...
         10000, 25, 10, '2023-06-01', 'active', 'male', 'Entry', 2, 78,
        ...
        (emp_id_10, company_uuid, 'AQL010', 'Layla', 'Al-Najjar', 'ليلى', 'النجار',
         ...
         9000, 25, 10, '2023-09-01', 'active', 'female', 'Entry', 1, 75,
         false, false, true, true, 21, false,
