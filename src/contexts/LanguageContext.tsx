...
const translations = {
  ar: {
    ...
    'ai.smart_recommendations': 'محرك التوصيات الذكية',
    'ai.smart_recommendations_desc': 'ذكاء المواهب المدعوم بالذكاء الاصطناعي الذي يحدد المطابقات المثالية للنقل والترقيات وتعيين الأدوار',
    'ai.how_sanadhr_creates': 'كيف ينشئ سند للموارد البشرية التوصيات الذكية',
    'ai.advanced_ml_desc': 'التعلم الآلي المتقدم يحلل نقاط بيانات متعددة لقرارات المواهب المثلى',
    'ai.data_collection': 'جمع البيانات',
    'ai.data_collection_desc': 'الذكاء الاصطناعي يحلل مقاييس الأداء والمهارات والخبرة والأنماط السلوكية',
    'ai.data_points': '+50 نقطة بيانات',
    'ai.ai_matching': 'المطابقة بالذكاء الاصطناعي',
    'ai.ai_matching_desc': 'نماذج التعلم الآلي تحسب درجات التوافق عبر أبعاد متعددة',
    'ai.neural_networks': 'الشبكات العصبية',
    'ai.smart_ranking': 'التصنيف الذكي',
    'ai.smart_ranking_desc': 'التوصيات مصنفة حسب احتمالية النجاح والمواءمة الاستراتيجية',
    'ai.accuracy_rate': '87.6% دقة',
    'ai.total_recommendations': 'إجمالي التوصيات',
    'ai.prediction_accuracy': 'دقة التنبؤ',
    'ai.implemented_actions': 'الإجراءات المنفذة',
    'ai.success_rate': 'معدل النجاح',
    'ai.this_month': 'هذا الشهر',
    'ai.across_departments': 'عبر 12 قسماً',
    'ai.based_historical': 'بناءً على النتائج التاريخية',
    'ai.acceptance_rate': 'معدل القبول',
    'ai.post_implementation': 'أداء ما بعد التنفيذ',
    'ai.current_recommendations': 'التوصيات الحالية',
    'ai.ai_analysis': 'تحليل الذكاء الاصطناعي',
    'ai.decision_factors': 'عوامل القرار',
    'ai.success_tracking': 'تتبع النجاح',
    'ai.active_talent_recommendations': 'توصيات المواهب النشطة',
    'ai.ai_generated_suggestions': 'اقتراحات مُولدة بالذكاء الاصطناعي بناءً على التحليل الفوري',
    'ai.match_score': 'نقاط المطابقة',
    'ai.ai_analysis_framework': 'إطار تحليل الذكاء الاصطناعي',
    'ai.ml_models_desc': 'كيف تقيّم نماذج التعلم الآلي لدينا إمكانات المواهب',
    'ai.performance_metrics_analysis': 'تحليل مقاييس الأداء',
    'ai.historical_performance': 'الأداء التاريخي',
    'ai.skill_assessments': 'تقييمات المهارات',
    'ai.growth_trajectory': 'مسار النمو',
    'ai.peer_feedback': 'ملاحظات الأقران',
    'ai.behavioral_analysis': 'التحليل السلوكي',
    'ai.leadership_indicators': 'مؤشرات القيادة',
    'ai.adaptability_score': 'نقاط القدرة على التكيف',
    'ai.cultural_fit': 'التناسب الثقافي',
    'ai.career_aspirations': 'التطلعات المهنية',
    'ai.weight': 'وزن',
    'ai.key_decision_factors': 'عوامل القرار الرئيسية',
    'ai.critical_elements_desc': 'العناصر الحرجة التي تؤثر على دقة التوصيات',
    'ai.role_requirements_matching': 'مطابقة متطلبات الدور',
    'ai.role_requirements_desc': 'الذكاء الاصطناعي يقارن مهارات المرشحين مع متطلبات الوظيفة التفصيلية وملفات النجاح',
    'ai.performance_trajectory_analysis': 'تحليل مسار الأداء',
    'ai.performance_trajectory_desc': 'اتجاهات الأداء التاريخية تتنبأ باحتمالية النجاح المستقبلي في الأدوار الجديدة',
    'ai.team_dynamics_culture': 'ديناميكيات الفريق والتناسب الثقافي',
    'ai.team_dynamics_desc': 'تحليل الشبكة الاجتماعية يضمن أن التوصيات تراعي كيمياء الفريق والثقافة',
    'ai.success_tracking_outcomes': 'تتبع النجاح والنتائج',
    'ai.measure_improve_desc': 'كيف نقيس ونحسن فعالية التوصيات',
    'ai.six_month_success': 'معدل نجاح 6 أشهر',
    'ai.performance_improvement': 'تحسن الأداء',
    'ai.successful_placements': 'التوظيفات الناجحة',
    'ai.recent_success_stories': 'قصص النجاح الأخيرة',
    'ai.promoted_analyst': 'المحلل المرقى حقق أداءً أفضل بنسبة 34% في الدور الجديد خلال 3 أشهر',
    'ai.cross_department': 'النقل بين الأقسام أدى إلى زيادة الإنتاجية بنسبة 28% للفريق المستقبل',
    'ai.recommendation_management': 'إدارة التوصيات',
    'ai.review_act_desc': 'مراجعة واتخاذ إجراءات بشأن توصيات المواهب المُولدة بالذكاء الاصطناعي',
    'ai.review_new_recommendations': 'مراجعة التوصيات الجديدة',
    'ai.set_recommendation_criteria': 'تعيين معايير التوصيات',
    'ai.view_success_analytics': 'عرض تحليلات النجاح',

    // Analytics (Arabic)
    'analytics.advanced_analytics': 'التحليلات المتقدمة',
    'analytics.data_driven_insights': 'رؤى مدفوعة بالبيانات وتحليلات القوى العاملة',

    // Consulting (Arabic)  
    'consulting.premium_consulting': 'أدوات الاستشارات المتميزة',
    'consulting.executive_hr_consulting': 'استشارات الموارد البشرية التنفيذية والتحول',

    // Government (Arabic)
    'government.government_integrations': 'التكاملات الحكومية',
    'government.seamless_integration': 'تكامل سلس مع المنصات الحكومية السعودية',

    // Strategic (Arabic)
    'strategic.strategic_hr': 'الموارد البشرية الاستراتيجية',
    'strategic.strategic_hr_desc': 'التخطيط الاستراتيجي للقوى العاملة وإدارة المواهب'
  },
  en: {
    // Navigation
