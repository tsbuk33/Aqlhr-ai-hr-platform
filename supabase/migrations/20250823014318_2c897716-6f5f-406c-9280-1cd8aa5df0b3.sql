...
CREATE OR REPLACE FUNCTION public.osi_get_overview_v1(p_tenant uuid)
RETURNS TABLE(
  total_layers int,
...
-- Layers data RPC
CREATE OR REPLACE FUNCTION public.osi_get_layers_v1(p_tenant uuid)
...
-- Span outliers RPC
CREATE OR REPLACE FUNCTION public.osi_get_span_outliers_v1(p_tenant uuid)
...
CREATE OR REPLACE FUNCTION public.osi_get_settings_v1(p_tenant uuid)
...
CREATE OR REPLACE FUNCTION public.osi_refresh_v1(p_tenant uuid)
...
CREATE OR REPLACE FUNCTION public.osi_seed_demo_data_v1(p_tenant uuid)
RETURNS void LANGUAGE plpgsql SECURITY DEFINER AS $$
DECLARE
  ceo_id uuid;
  vp1_id uuid;
