...
(gen_random_uuid(), 'saudi_local', 'SAUDI_STRICT', false, false, 'highly_confidential', 'comprehensive', 'compliance@aqlhr.com', 'Ahmed Al-Saudi', ARRAY['saudi_pdpl', 'saudi_labor_law', 'mci_regulations']),

-- International company in Saudi
(gen_random_uuid(), 'international_saudi', 'INTERNATIONAL_SAUDI', true, true, 'confidential', 'standard', 'compliance@intl-company.com', 'Sarah Johnson', ARRAY['saudi_pdpl', 'gdpr', 'gcc_data_protection']),

-- Multinational corporation
(gen_random_uuid(), 'multinational', 'GLOBAL_STANDARD', true, true, 'internal', 'standard', 'compliance@mnc-global.com', 'David Chen', ARRAY['gdpr', 'ccpa', 'appi']);
