-- Get existing company IDs or create a default one for testing
DO $$ 
DECLARE 
    company_uuid uuid;
BEGIN
    ...
    IF company_uuid IS NULL THEN
        INSERT INTO public.companies (name, cr_number, industry) 
        VALUES ('Demo Company', 'CR123456789', 'Technology')
        RETURNING id INTO company_uuid;
    END IF;

    -- Insert sample data into learning_progress_tracking
    INSERT INTO public.learning_progress_tracking (
      ...
      (gen_random_uuid(), company_uuid, 'AI & Machine Learning', 'Technical', 75.0, 90.0, 85.5, 12, CURRENT_DATE - 2, 0.82),
      (gen_random_uuid(), company_uuid, 'Leadership Development', 'Management', 67.0, 85.0, 67.2, 8, CURRENT_DATE - 1, 0.75),
      (gen_random_uuid(), company_uuid, 'Vision 2030 Strategy', 'Strategic', 92.0, 95.0, 92.8, 15, CURRENT_DATE, 0.89),
      (gen_random_uuid(), company_uuid, 'Cultural Intelligence', 'Cultural', 45.0, 75.0, 45.1, 6, CURRENT_DATE - 5, 0.68),
      (gen_random_uuid(), company_uuid, 'HR Technology', 'Technical', 78.0, 90.0, 78.9, 11, CURRENT_DATE - 1, 0.85),
      (gen_random_uuid(), company_uuid, 'Digital Transformation', 'Innovation', 100.0, 100.0, 100.0, 20, CURRENT_DATE - 2, 0.95),
      (gen_random_uuid(), company_uuid, 'Project Management', 'Business', 33.0, 80.0, 33.5, 4, CURRENT_DATE - 7, 0.65),
      (gen_random_uuid(), company_uuid, 'Cross-Cultural Communication', 'Cultural', 88.0, 95.0, 88.3, 14, CURRENT_DATE, 0.87);

    -- Insert sample data into engagement_metrics_tracking
    INSERT INTO public.engagement_metrics_tracking (
      ...
      (gen_random_uuid(), company_uuid, 87.5, 94.2, 12, 5, 8, 92.1, 0.85, CURRENT_DATE),
      (gen_random_uuid(), company_uuid, 74.2, 86.8, 6, 2, 4, 78.5, 0.72, CURRENT_DATE - 1),
      (gen_random_uuid(), company_uuid, 91.8, 98.1, 18, 9, 12, 95.7, 0.92, CURRENT_DATE),
      (gen_random_uuid(), company_uuid, 62.3, 75.9, 3, 1, 2, 65.2, 0.58, CURRENT_DATE - 2),
      (gen_random_uuid(), company_uuid, 83.6, 90.4, 10, 4, 7, 86.8, 0.81, CURRENT_DATE),
      (gen_random_uuid(), company_uuid, 79.4, 88.1, 8, 3, 5, 81.3, 0.78, CURRENT_DATE - 1),
      (gen_random_uuid(), company_uuid, 95.2, 99.8, 25, 15, 18, 98.4, 0.97, CURRENT_DATE),
      (gen_random_uuid(), company_uuid, 68.9, 81.5, 4, 1, 3, 72.6, 0.69, CURRENT_DATE - 3);

    -- Insert sample data into learning_engagement_insights
    INSERT INTO public.learning_engagement_insights (
      ...
      (company_uuid, gen_random_uuid(), 89.7, 85.2, 15.3, 12.8, 
      ...
      (company_uuid, gen_random_uuid(), 72.4, 67.1, 8.9, 6.5, 
      ...
      (company_uuid, gen_random_uuid(), 94.1, 92.8, 18.7, 16.2, 
      ...
      (company_uuid, gen_random_uuid(), 63.8, 59.4, 5.2, 4.1, 
      ...
      (company_uuid, gen_random_uuid(), 81.5, 78.9, 12.4, 10.7, 
      ...
      (company_uuid, gen_random_uuid(), 76.2, 73.6, 9.8, 8.3, 
    ...
    INSERT INTO public.cross_system_recommendations (
      ...
      (company_uuid, gen_random_uuid(), 'leo', 'geo', 'engagement_boost', 
       jsonb_build_object(
      ...
      (company_uuid, gen_random_uuid(), 'geo', 'leo', 'learning_recommendation', 
       jsonb_build_object(
      ...
      (company_uuid, gen_random_uuid(), 'leo', 'geo', 'skill_showcase', 
       jsonb_build_object(
      ...
      (company_uuid, gen_random_uuid(), 'geo', 'leo', 'adaptive_learning', 
       jsonb_build_object(
    ...
    INSERT INTO public.ai_sync_events (
      ...
      (company_uuid, 'leo_geo_sync', 'learning_progress_tracking', gen_random_uuid(),
       ARRAY['leo', 'geo', 'analytics', 'recommendations'],
       jsonb_build_object('sync_type', 'learning_update', 'timestamp', now(), 'status', 'success'),
       'completed'),
      
      (company_uuid, 'engagement_sync', 'engagement_metrics_tracking', gen_random_uuid(),
       ARRAY['geo', 'leo', 'analytics', 'predictions'],
       jsonb_build_object('sync_type', 'engagement_update', 'timestamp', now(), 'status', 'success'),
       'completed'),
      
      (company_uuid, 'recommendation_generation', 'cross_system_recommendations', gen_random_uuid(),
