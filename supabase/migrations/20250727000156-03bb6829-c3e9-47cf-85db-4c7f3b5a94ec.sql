...
-- Insert sample profiles (ON CONFLICT uses primary key)
...
-- Insert user_roles (ON CONFLICT uses the unique constraint on user_id, role)
INSERT INTO public.user_roles (user_id, role)
VALUES
  ('33333333-3333-3333-3333-333333333333','admin'),
  ('44444444-4444-4444-4444-444444444444','hr_manager'),
  ('55555555-5555-5555-5555-555555555555','employee')
ON CONFLICT (user_id, role) DO NOTHING;

-- Insert pilot_group_users (ON CONFLICT uses user_id which should be unique)
...
-- Insert translation_feedback (ON CONFLICT uses the unique constraint on translation_key, user_id, company_id)
