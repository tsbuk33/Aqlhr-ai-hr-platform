-- Update the CCI balance score calculation to include evidence factor
-- This replaces the placeholder 70 with actual evidence integration

-- Update cci_compute_scores_v1 function to use evidence factor
