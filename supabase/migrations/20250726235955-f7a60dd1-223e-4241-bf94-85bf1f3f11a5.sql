...
-- Insert user_roles (using valid app_role enum values: admin, moderator, user)
...
VALUES
  ...
  ('44444444-4444-4444-4444-444444444444', ARRAY['i18n_review'], 'moderator', true, now() + interval '1 year'),
