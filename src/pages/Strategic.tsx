...
const Strategic = () => {
  return (
    <div className="container mx-auto p-6 space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-foreground">Strategic HR & Analytics</h1>
        <p className="text-muted-foreground">Workforce planning and strategic HR management</p>
      </div>
