-- CRITICAL SECURITY FIX: Secure the employees table
...
-- ============================================================================
-- STEP 4: Create audit log for security events
-- ============================================================================
...
-- ============================================================================
-- This migration resolves the critical security vulnerability by:
-- 1. Enabling Row Level Security on the employees table
-- 2. Implementing role-based access control with company-level tenant isolation
-- 3. Creating security definer functions to prevent RLS policy recursion
-- 4. Adding comprehensive audit logging for employee data access
-- 5. Following the principle of least privilege for data access
-- 
-- Access Control Matrix:
-- - Super Admin: Full access to all employees across companies
-- - Company Admin: Full access to employees in their company only  
-- - HR Manager: Full access to employees in their company only
-- - Regular Employee: Read/limited update access to their own record only
-- - Unauthenticated: No access (explicitly denied)
--
-- All policies respect company-level tenant isolation to prevent cross-company data leaks.