...
DROP POLICY IF EXISTS "tenant_rw_gov_adapters" ON public.gov_adapters;
DROP POLICY IF EXISTS "tenant_rw_gov_sync_logs" ON public.gov_sync_logs;
DROP POLICY IF EXISTS "tenant_rw_gov_changes" ON public.gov_changes;
