...
-- Insert 20 key employees with proper UUIDs
...
-- Key Saudi Management & Senior Staff (12 employees - 60% Saudi)
...
('a0b1c2d3-e4f5-6789-abcd-ef0123456789', 'ALZ011', '1357924680', null, 'Saud', 'Al-Otaibi', 'سعود', 'العتيبي', 'saud.otaibi@almalz.com', '+966511234567', 'Saudi', true, '2020-01-20', 'Construction', 'Mason', 'بناء', 3800.00, 'active'),
('a0b1c2d3-e4f5-6789-abcd-ef0123456789', 'ALZ012', '2468013579', null, 'Nayef', 'Al-Qahtani', 'نايف', 'القحطاني', 'nayef.qahtani@almalz.com', '+966523456789', 'Saudi', true, '2019-09-19', 'Engineering', 'Structural Engineer', 'مهندس إنشائي', 10500.00, 'active'),

-- Key Non-Saudi Skilled Workers (8 employees - 40% expatriates)
('a0b1c2d3-e4f5-6789-abcd-ef0123456789', 'ALZ013', null, '2123456789', 'Muhammad', 'Hassan', 'محمد', 'حسن', 'muhammad.hassan@almalz.com', '+966533456789', 'Pakistani', false, '2020-05-15', 'Construction', 'Steel Fixer', 'حداد تسليح', 3200.00, 'active'),
('a0b1c2d3-e4f5-6789-abcd-ef0123456789', 'ALZ014', null, '2234567890', 'Ahmed', 'Mohamed', 'أحمد', 'محمد', 'ahmed.mohamed@almalz.com', '+966534567890', 'Egyptian', false, '2019-08-22', 'Construction', 'Tile Installer', 'عامل بلاط', 3000.00, 'active'),
('a0b1c2d3-e4f5-6789-abcd-ef0123456789', 'ALZ015', null, '2345678901', 'Rajesh', 'Kumar', 'راجيش', 'كومار', 'rajesh.kumar@almalz.com', '+966535678901', 'Indian', false, '2021-01-18', 'Engineering', 'CAD Operator', 'مشغل الكاد', 4500.00, 'active'),
('a0b1c2d3-e4f5-6789-abcd-ef0123456789', 'ALZ016', null, '2456789012', 'Ali', 'Mansour', 'علي', 'منصور', 'ali.mansour@almalz.com', '+966536789012', 'Syrian', false, '2020-09-30', 'Construction', 'Welder', 'لحام', 3800.00, 'active'),
('a0b1c2d3-e4f5-6789-abcd-ef0123456789', 'ALZ017', null, '2567890123', 'Pradeep', 'Singh', 'براديب', 'سينغ', 'pradeep.singh@almalz.com', '+966537890123', 'Indian', false, '2019-12-05', 'Operations', 'Heavy Equipment Operator', 'مشغل معدات ثقيلة', 4200.00, 'active'),
('a0b1c2d3-e4f5-6789-abcd-ef0123456789', 'ALZ018', null, '2678901234', 'Mahmoud', 'Abdel', 'محمود', 'عبدال', 'mahmoud.abdel@almalz.com', '+966538901234', 'Egyptian', false, '2021-06-12', 'Construction', 'Concrete Worker', 'عامل خرسانة', 2800.00, 'active'),
('a0b1c2d3-e4f5-6789-abcd-ef0123456789', 'ALZ019', null, '2901234567', 'Dinesh', 'Patel', 'دينيش', 'باتيل', 'dinesh.patel@almalz.com', '+966541234567', 'Indian', false, '2019-07-08', 'Operations', 'Crane Operator', 'مشغل كرين', 5500.00, 'active'),
('a0b1c2d3-e4f5-6789-abcd-ef0123456789', 'ALZ020', null, '3012345678', 'Tariq', 'Hussain', 'طارق', 'حسين', 'tariq.hussain@almalz.com', '+966542345678', 'Pakistani', false, '2021-10-22', 'Safety', 'Fire Safety Officer', 'ضابط إطفاء', 4800.00, 'active');