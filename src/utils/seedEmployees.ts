...
function generateEmployee(index: number, companyId: string): NewEmployee {
  ...
  return {
    ...
    is_saudi: isSaudi,
    gender,
    family_status: getRandomElement(['Single', 'Married', 'Divorced', 'Widowed']),
    ...
    annual_tickets_type: !isSaudi ? getRandomElement(['Economy', 'Business']) : null,
    ...
    recruitment_type: getRandomElement(['Direct Hire', 'Agency', 'Internal Transfer', 'Referral']),
    ...
    schooling_fees_coverage: Math.random() < 0.3 ? getRandomElement(['Full', 'Partial', '80%', '50%']) : null,
