...
export const generateDummyPositions = (): DummyPosition[] => [
  {
    ...
    skillsRequired: 10,
    skillsMatched: 8,
    description: 'Responsible for overall HR strategy and operations',
  ...
  },
  {
    ...
    skillsRequired: 8,
    skillsMatched: 7,
    description: 'Handle complex accounting operations and financial reporting',
    requirements: ['Bachelor in Accounting', '4+ years experience', 'CPA preferred'],
    responsibilities: ['Financial reporting', 'Account reconciliation', 'Tax preparation'],
    count: 3
  },
  {
    id: '3',
  ...
  },
  {
    ...
    requirements: ['Bachelor in Marketing', '2+ years experience', 'Digital marketing skills'],
    responsibilities: ['Campaign management', 'Content creation', 'Market analysis'],
    count: 3
  },
  {
    id: '5',
    ...
    requirements: ['Bachelor in Business', '5+ years experience', 'PMP certification'],
    responsibilities: ['Operations oversight', 'Process improvement', 'Team management'],
    count: 2
  },
  {
    id: '6',
    ...
    skillsRequired: 5,
    skillsMatched: 4,
    description: 'Support HR functions and employee services',
    requirements: ['Bachelor in HR', '1+ years experience', 'HRIS knowledge'],
    responsibilities: ['Recruitment support', 'Employee relations', 'HR administration'],
    count: 4
  },
  {
    id: '7',
    ...
    requirements: ['Bachelor in Computer Science', '3+ years experience', 'Full-stack development'],
    responsibilities: ['System design', 'Code development', 'Architecture planning'],
    count: 4
  },
  {
    id: '8',
  ...
  },
  {
    ...
    skillsRequired: 10,
    skillsMatched: 8,
    description: 'Lead software development and mentor junior developers',
    requirements: ['Bachelor in Computer Science', '5+ years experience', 'Leadership skills'],
    responsibilities: ['Technical leadership', 'Code review', 'Mentoring'],
    count: 2
  },
  {
    id: '11',
    ...
    skillsRequired: 9,
    skillsMatched: 7,
    description: 'Manage project lifecycle and team coordination',
    requirements: ['Bachelor degree', '4+ years experience', 'PMP certification'],
