...
const translations = {
  ar: {
    ...
    'nav.ai_sync_engine': 'محرك المزامنة الذكي',
     ...
     // Navigation Sub-items - Tools & Integrations
     'nav.communication_collaboration': 'التواصل والتعاون',
     'nav.microsoft_teams': 'مايكروسوفت تيمز',
     'nav.slack': 'سلاك',
     'nav.whatsapp_business': 'واتساب للأعمال',
     'nav.outlook_integration': 'تكامل أوتلوك',
     'nav.gmail_integration': 'تكامل جيميل',
     'nav.document_management': 'إدارة المستندات',
     'nav.sharepoint': 'شير بوينت',
     'nav.google_drive': 'جوجل درايف',
     'nav.onedrive': 'وان درايف',
     'nav.dropbox': 'دروب بوكس',
     'nav.docusign': 'دوكيو ساين',
     'nav.adobe_sign': 'أدوبي ساين',
     'nav.calendar_scheduling': 'التقويم والجدولة',
     'nav.google_calendar': 'تقويم جوجل',
     'nav.outlook_calendar': 'تقويم أوتلوك',
     'nav.calendly': 'كالندلي',
     'nav.room_booking': 'حجز القاعات',
     'nav.analytics_bi': 'التحليلات وذكاء الأعمال',
     'nav.power_bi': 'باور بي آي',
     'nav.tableau': 'تابلو',
     'nav.google_analytics': 'جوجل أناليتكس',
     'nav.custom_connectors': 'الموصلات المخصصة',
     'nav.learning_development': 'التعلم والتطوير',
     'nav.linkedin_learning': 'لينكد إن للتعلم',
     'nav.coursera_business': 'كورسيرا للأعمال',
     'nav.udemy_business': 'يوديمي للأعمال',
     'nav.local_training': 'منصات التدريب المحلية',
     'nav.automation_platforms': 'منصات الأتمتة',
     'nav.zapier': 'زابيير',
     'nav.power_automate': 'باور أوتوميت',
     'nav.custom_workflows': 'سير العمل المخصص',
    
    // Core HR - Benefits Administration
    'core_hr.benefits_administration': 'إدارة المزايا',
    'nav.mudad_platform': 'منصة مدد',
    'nav.elm_platform': 'منصة علم',
    ...
    'zatca.subtitle': 'امتثال وإقرارات هيئة الزكاة والضريبة والجمارك',
    'zatca.file_return': 'تقديم الإقرار',
    'zatca.vat_returns_filed': 'إقرارات ضريبة القيمة المضافة المقدمة',
    'zatca.annual_compliance': 'سجل الامتثال السنوي',
    'zatca.compliance_rate': 'معدل الامتثال',
    'zatca.overall_compliance': 'الامتثال العام للضرائب',
    'zatca.tax_collected': 'الضريبة المحصلة',
    'zatca.vat_collected_year': 'ضريبة القيمة المضافة المحصلة هذا العام',
    'zatca.penalties_avoided': 'الغرامات المتجنبة',
    'zatca.savings_compliance': 'المدخرات من الامتثال',
    'zatca.zero_penalties': 'صفر غرامات',
    'zatca.on_time': '100% في الوقت المحدد',
    'zatca.excellent': 'ممتاز',
    'zatca.vs_last_year': '+12% مقارنة بالعام الماضي',
    'zatca.overview': 'نظرة عامة',
    'zatca.returns': 'الإقرارات الضريبية',
    'zatca.payments': 'المدفوعات',
    'zatca.compliance': 'الامتثال',
    'zatca.vat_return_history': 'تاريخ إقرارات ضريبة القيمة المضافة',
    'zatca.track_returns': 'تتبع جميع الإقرارات الضريبية المقدمة',
    'zatca.filed': 'مقدم',
    'zatca.tax_payments': 'المدفوعات الضريبية',
    'zatca.payment_history': 'تاريخ وحالة المدفوعات',
    'zatca.vat_payments': 'مدفوعات ضريبة القيمة المضافة',
    'zatca.withholding_tax': 'ضريبة الاستقطاع',
    'zatca.zakat_obligations': 'التزامات الزكاة',
    'zatca.up_to_date': 'محدث',
    'zatca.current': 'حالي',

    // Company Data Upload
    'upload.company_data_integration': 'تكامل بيانات الشركة',
    'upload.company_data_description': 'رفع ملفات بيانات الشركة للتكامل التلقائي مع جميع وحدات سند للموارد البشرية وأنظمة الذكاء الاصطناعي',
    'upload.processing_data': 'معالجة بيانات الشركة...',
    'upload.integrating_with_modules': 'التكامل مع وحدات الموارد البشرية وأنظمة الذكاء الاصطناعي',
    'upload.complete': 'مكتمل',
    'upload.drag_drop_files': 'اسحب وأفلت ملفات شركتك هنا',
    'upload.supported_formats': 'يدعم ملفات إكسل (.xlsx, .xls) وPDF ومستندات Word',
    'upload.browse_files': 'تصفح الملفات',
    'upload.ai_integration_title': 'التكامل المدعوم بالذكاء الاصطناعي',
    'upload.ai_integration_description': 'البيانات المرفوعة تتزامن تلقائياً مع وحدات الرواتب وتحليلات الموارد البشرية والامتثال وأنظمة الذكاء الاصطناعي التنبؤية',
    'zatca.compliant': 'متوافق',
    'zatca.compliance_status': 'حالة الامتثال',
    'zatca.regulatory_overview': 'نظرة عامة على الامتثال التنظيمي لهيئة الزكاة والضريبة والجمارك',
    'zatca.registration_status': 'حالة التسجيل',
    'zatca.filing_requirements': 'متطلبات التقديم',
    'zatca.payment_obligations': 'التزامات الدفع',
    'zatca.record_keeping': 'حفظ السجلات',
    'zatca.active': 'نشط',
    'zatca.met': 'مستوفى',
    ...
    'dashboard.subtitle': 'منصة إدارة الموارد البشرية الشاملة - مصممة للتميز في المملكة العربية السعودية',
     ...
     'dashboard.gov_integrations': 'لوحة التكامل',
     'dashboard.connected_platforms': 'المنصات المتصلة',
     'dashboard.compliance_score': 'لوحة الامتثال',
     'dashboard.regulatory_compliance': 'الامتثال التنظيمي',
     'dashboard.saudization_rate': 'لوحة السعودة',
     'dashboard.green_nitaqat_target': 'الهدف: 70% (نطاقات أخضر)',
     'dashboard.active_users': 'لوحة النشطاء',
     'dashboard.employee_self_service': 'الخدمة الذاتية للموظفين',
     'dashboard.documents_processed': 'لوحة الوثائق',
     'dashboard.ai_powered_verification': 'التحقق بالذكاء الاصطناعي',
     'dashboard.training_hours': 'لوحة التدريب',
     'dashboard.skills_development_completed': 'تطوير المهارات المكتمل',
     'dashboard.monthly_payroll': 'لوحة الرواتب',
      'dashboard.december_2024_processed': 'ديسمبر 2024 معالج',
      'dashboard.system_engineer': 'مهندس النظام الذكي',
      'dashboard.system_engineer_description': 'ذكاء اصطناعي فائق تكيفي يكتشف ويراقب ويحسن جميع الوحدات والأدوات تلقائياً',
      'dashboard.auto_adaptive': 'تكيف تلقائي',
      'dashboard.future_proof': 'مقاوم للمستقبل',
      'dashboard.continuous_monitoring': 'مراقبة مستمرة',
      'dashboard.open_dashboard': 'فتح لوحة التحكم',
     'dashboard.attendance_rate': 'لوحة الحضور',
     'dashboard.real_time_tracking': 'التتبع في الوقت الفعلي',
     'dashboard.platform_status_overview': 'نظرة عامة على حالة المنصة',
     'dashboard.core_hr_modules': 'وحدات الموارد البشرية',
    ...
    // MOL Compliance (Arabic)
    'mol.title': 'امتثال وزارة الموارد البشرية',
    'mol.subtitle': 'مراقبة الامتثال لوزارة الموارد البشرية والتنمية الاجتماعية',
    'mol.overview': 'نظرة عامة',
    'mol.compliance_score': 'نقاط الامتثال',
    'mol.active_violations': 'المخالفات النشطة',
    'mol.resolved_issues': 'القضايا المحلولة',
    'mol.inspection_ready': 'جاهز للتفتيش',
    'mol.labor_law_compliance': 'الامتثال لقانون العمل',
    'mol.employee_rights': 'حماية حقوق الموظفين',
    'mol.safety_standards': 'معايير السلامة',
    'mol.training_requirements': 'متطلبات التدريب',
    'mol.documentation': 'التوثيق',
    'mol.inspection_history': 'تاريخ التفتيش',
    'mol.corrective_actions': 'الإجراءات التصحيحية',
    'mol.compliance_status': 'حالة الامتثال',
    'mol.last_inspection': 'آخر تفتيش',
    'mol.next_inspection': 'موعد التفتيش القادم',
    'mol.violations_resolved': 'المخالفات المحلولة',
    'mol.pending_actions': 'الإجراءات المعلقة',
    'mol.regulatory_updates': 'التحديثات التنظيمية',
    'mol.policy_changes': 'تغييرات السياسة',
    'mol.compliance_alerts': 'تنبيهات الامتثال',
    'mol.compliant': 'متوافق',
    ...
    'government.identity_verification': 'التحقق من الهوية والتحقق',
     ...
     'government.documents': 'المستندات',
     'government.security': 'الأمان',
     'government.verified_ids': 'الهويات المتحققة',
     'government.total_id_verifications': 'إجمالي التحققات من الهوية',
     'government.verification_rate': 'معدل التحقق',
     'government.success_percentage': 'نسبة النجاح',
     'government.response_time': 'وقت الاستجابة',
     'government.average_api_response': 'متوسط استجابة API',
     'government.daily_checks': 'التحققات اليومية',
     'government.verifications_today': 'التحققات اليوم',
     'government.test_connection': 'اختبار الاتصال',
     'government.identity_verification_process': 'عملية التحقق من الهوية',
     'government.realtime_id_validation': 'التحقق من الهوية في الوقت الفعلي',
     'government.saudi_nationals': 'المواطنون السعوديون',
     'government.residents': 'المقيمون',
     'government.failed_verifications': 'التحققات الفاشلة',
     'government.document_validation': 'التحقق من المستندات',
     'government.validate_official_documents': 'التحقق من المستندات الرسمية',
     'government.national_id_cards': 'بطاقات الهوية الوطنية',
     'government.validated': 'متحقق منها',
     'government.residence_permits': 'تصاريح الإقامة',
     'government.passport_documents': 'مستندات جواز السفر',
     'government.security_privacy': 'الأمان والخصوصية',
     'government.data_protection_measures': 'تدابير حماية البيانات',
     'government.data_encryption': 'تشفير البيانات',
     'government.api_security': 'أمان API',
      'government.compliant': 'متوافق',
      
      // Translation Integrity Engine - محرك سلامة الترجمة
      'translation.integrity.engine': 'محرك سلامة الترجمة',
      'translation.self.healing.description': 'نظام ترجمة ذاتي الإصلاح مدعوم بالذكاء الاصطناعي مع اكتشاف وإصلاح تلقائي',
      'translation.health.score': 'نقاط صحة الترجمة',
      'translation.auditing': 'جاري تشغيل التدقيق...',
      'translation.run.audit': 'تشغيل تدقيق الترجمة',
      'translation.healing': 'الإصلاح الذاتي...',
      'translation.self.heal': 'الإصلاح التلقائي للترجمات المفقودة',
      'translation.audits': 'تدقيقات الترجمة',
      'translation.ai.patches': 'رقع الذكاء الاصطناعي',
      'translation.analytics': 'تحليلات الترجمة',
      'translation.audit.history': 'تاريخ تدقيق الترجمة',
      'translation.total.keys': 'إجمالي المفاتيح',
      'translation.missing.arabic': 'العربية المفقودة',
      'translation.ai.patched': 'رقع الذكاء الاصطناعي',
      'translation.hardcoded.strings': 'النصوص المشفرة',
      'translation.completion.rate': 'معدل الإكمال',
      'translation.no.audits': 'لا توجد تدقيقات متاحة. قم بتشغيل تدقيق لرؤية النتائج.',
      'translation.ai.patches.applied': 'رقع ترجمة الذكاء الاصطناعي المطبقة',
      'translation.confidence': 'الثقة',
      'translation.no.patches': 'لم يتم تطبيق أي رقع بعد.',
      'translation.quality.metrics': 'مؤشرات جودة الترجمة',
      'translation.translated.keys': 'المفاتيح المترجمة',
      'translation.pending.review': 'في انتظار المراجعة',
      'translation.recent.activity': 'النشاط الأخير للترجمة',
      'translation.auto.translated': 'مترجم تلقائياً',
      'translation.audit.completed': 'تم تدقيق الترجمة',
      'translation.keys.scanned': 'مفاتيح تم فحصها',
      'translation.audit.failed': 'فشل تدقيق الترجمة',
      'translation.healing.completed': 'تم الإصلاح الذاتي',
      'translation.keys.healed': 'مفاتيح تم إصلاحها',
      'translation.healing.failed': 'فشل الإصلاح الذاتي',
  ...
  en: {
     ...
     // Navigation Sub-items - Tools & Integrations
     'nav.communication_collaboration': 'Communication & Collaboration',
     'nav.microsoft_teams': 'Microsoft Teams',
     'nav.slack': 'Slack',
     'nav.whatsapp_business': 'WhatsApp Business',
     'nav.outlook_integration': 'Outlook Integration',
     'nav.gmail_integration': 'Gmail Integration',
     'nav.document_management': 'Document Management',
     'nav.sharepoint': 'SharePoint',
     'nav.google_drive': 'Google Drive',
     'nav.onedrive': 'OneDrive',
     'nav.dropbox': 'Dropbox',
     'nav.docusign': 'DocuSign',
     'nav.adobe_sign': 'Adobe Sign',
     'nav.calendar_scheduling': 'Calendar & Scheduling',
     'nav.google_calendar': 'Google Calendar',
     'nav.outlook_calendar': 'Outlook Calendar',
     'nav.calendly': 'Calendly',
     'nav.room_booking': 'Room Booking',
     'nav.analytics_bi': 'Analytics & BI',
     'nav.power_bi': 'Power BI',
     'nav.tableau': 'Tableau',
     'nav.google_analytics': 'Google Analytics',
     'nav.custom_connectors': 'Custom Connectors',
     'nav.learning_development': 'Learning & Development',
     'nav.linkedin_learning': 'LinkedIn Learning',
     'nav.coursera_business': 'Coursera Business',
     'nav.udemy_business': 'Udemy Business',
     'nav.local_training': 'Local Training Platforms',
      'nav.automation_platforms': 'Automation Platforms',
      'nav.zapier': 'Zapier',
      'nav.power_automate': 'Power Automate',
      'nav.custom_workflows': 'Custom Workflows',
    ...
    'nav.umm_al_qura_calendar': 'Umm Al-Qura Calendar - Official Hijri Calendar',
       ...
       'zatca.subtitle': 'Zakat, Tax and Customs Authority compliance',
       'zatca.file_return': 'File Return',
       'zatca.vat_returns_filed': 'VAT Returns Filed',
       'zatca.annual_compliance': 'Annual compliance record',
       'zatca.compliance_rate': 'Compliance Rate',
       'zatca.overall_compliance': 'Overall tax compliance',
       'zatca.tax_collected': 'Tax Collected',
       'zatca.vat_collected_year': 'VAT collected this year',
       'zatca.penalties_avoided': 'Penalties Avoided',
       'zatca.savings_compliance': 'Savings from compliance',
       'zatca.zero_penalties': 'Zero Penalties',
       'zatca.on_time': '100% on time',
       'zatca.excellent': 'Excellent',
       'zatca.vs_last_year': '+12% vs last year',
       'zatca.overview': 'Overview',
       'zatca.returns': 'Tax Returns',
       'zatca.payments': 'Payments',
       'zatca.compliance': 'Compliance',
       'zatca.vat_return_history': 'VAT Return History',
       'zatca.track_returns': 'Track all submitted tax returns',
       'zatca.filed': 'Filed',
       'zatca.tax_payments': 'Tax Payments',
       'zatca.payment_history': 'Payment history and status',
       'zatca.vat_payments': 'VAT Payments',
       'zatca.withholding_tax': 'Withholding Tax',
       'zatca.zakat_obligations': 'Zakat Obligations',
        'zatca.up_to_date': 'Up to Date',
        'zatca.current': 'Current',

        // Company Data Upload
        'upload.company_data_integration': 'Company Data Integration',
        'upload.company_data_description': 'Upload company data files to automatically integrate with all SanadHR modules and AI systems',
        'upload.processing_data': 'Processing Company Data...',
        'upload.integrating_with_modules': 'Integrating with HR modules and AI systems',
        'upload.complete': 'Complete',
        'upload.drag_drop_files': 'Drag & drop your company files here',
        'upload.supported_formats': 'Supports Excel (.xlsx, .xls), PDF, and Word documents',
        'upload.browse_files': 'Browse Files',
        'upload.ai_integration_title': 'AI-Powered Integration',
        'upload.ai_integration_description': 'Uploaded data automatically syncs with payroll, HR analytics, compliance modules, and predictive AI systems',
       'zatca.compliant': 'Compliant',
       'zatca.compliance_status': 'Compliance Status',
       'zatca.regulatory_overview': 'ZATCA regulatory compliance overview',
       'zatca.registration_status': 'Registration Status',
       'zatca.filing_requirements': 'Filing Requirements',
       'zatca.payment_obligations': 'Payment Obligations',
       'zatca.record_keeping': 'Record Keeping',
       'zatca.active': 'Active',
       'zatca.met': 'Met',

       // MOL Compliance
       'mol.title': 'MOL Compliance',
       'mol.subtitle': 'Ministry of Human Resources and Social Development compliance monitoring',
       'mol.overview': 'Overview',
       'mol.compliance_score': 'Compliance Score',
       'mol.active_violations': 'Active Violations',
       'mol.resolved_issues': 'Resolved Issues',
       'mol.inspection_ready': 'Inspection Ready',
       'mol.labor_law_compliance': 'Labor Law Compliance',
       'mol.employee_rights': 'Employee Rights Protection',
       'mol.safety_standards': 'Safety Standards',
       'mol.training_requirements': 'Training Requirements',
       'mol.documentation': 'Documentation',
       'mol.inspection_history': 'Inspection History',
       'mol.corrective_actions': 'Corrective Actions',
       'mol.compliance_status': 'Compliance Status',
       'mol.last_inspection': 'Last Inspection',
       'mol.next_inspection': 'Next Inspection Due',
       'mol.violations_resolved': 'Violations Resolved',
       'mol.pending_actions': 'Pending Actions',
       'mol.regulatory_updates': 'Regulatory Updates',
       'mol.policy_changes': 'Policy Changes',
       'mol.compliance_alerts': 'Compliance Alerts',
       'mol.compliant': 'Compliant',
    ...
    'common.import': 'Import',
     ...
     'dashboard.compliance_score': 'Dashboard Compliance',
     'dashboard.saudization_rate': 'Dashboard Saudization',
     'dashboard.active_users': 'Dashboard Users',
     'dashboard.documents_processed': 'Dashboard Documents',
     'dashboard.training_hours': 'Dashboard Training',
     'dashboard.monthly_payroll': 'Dashboard Payroll',
     'dashboard.attendance_rate': 'Dashboard Attendance',
     'dashboard.platform_status_overview': 'Platform Status Overview',
     'dashboard.core_hr_modules': 'HR Modules',
     'dashboard.payroll_modules': 'Payroll Modules', 
     'dashboard.ai_features': 'AI Features',
    ...
    'government.integration': 'Government Integrations',
    'government.qiwa': 'Qiwa Platform',
    'government.gosi': 'GOSI',
    'government.absher_platform': 'Absher Platform',
    'government.absher_desc': 'Electronic Government Services Platform',
    'government.verification': 'Verification',
    'government.documents': 'Documents',
    'government.security': 'Security',
    'government.verified_ids': 'Verified IDs',
    'government.total_id_verifications': 'Total ID Verifications',
    'government.verification_rate': 'Verification Rate',
    'government.success_percentage': 'Success Percentage',
    'government.response_time': 'Response Time',
    'government.average_api_response': 'Average API Response',
    'government.daily_checks': 'Daily Checks',
    'government.verifications_today': 'Verifications Today',
    'government.test_connection': 'Test Connection',
    'government.identity_verification_process': 'Identity Verification Process',
    'government.realtime_id_validation': 'Real-time ID Validation',
    'government.saudi_nationals': 'Saudi Nationals',
    'government.residents': 'Residents',
    'government.failed_verifications': 'Failed Verifications',
    'government.document_validation': 'Document Validation',
    'government.validate_official_documents': 'Validate Official Documents',
    'government.national_id_cards': 'National ID Cards',
    'government.validated': 'Validated',
    'government.residence_permits': 'Residence Permits',
    'government.passport_documents': 'Passport Documents',
    'government.security_privacy': 'Security & Privacy',
    'government.data_protection_measures': 'Data Protection Measures',
    'government.data_encryption': 'Data Encryption',
    'government.api_security': 'API Security',
    'government.compliance_status': 'Compliance Status',
      'government.compliant': 'Compliant',
      
      // Translation Integrity Engine
      'translation.integrity.engine': 'Translation Integrity Engine',
      'translation.self.healing.description': 'AI-powered self-healing translation system with automatic detection and remediation',
      'translation.health.score': 'Translation Health Score',
      'translation.auditing': 'Running Audit...',
      'translation.run.audit': 'Run Translation Audit',
      'translation.healing': 'Self-Healing...',
      'translation.self.heal': 'Auto-Heal Missing Translations',
      'translation.audits': 'Translation Audits',
      'translation.ai.patches': 'AI Patches',
      'translation.analytics': 'Translation Analytics',
      'translation.audit.history': 'Translation Audit History',
      'translation.total.keys': 'Total Keys',
      'translation.missing.arabic': 'Missing Arabic',
      'translation.ai.patched': 'AI Patched',
      'translation.hardcoded.strings': 'Hardcoded Strings',
      'translation.completion.rate': 'Completion Rate',
      'translation.no.audits': 'No audits available. Run an audit to see results.',
      'translation.ai.patches.applied': 'AI Translation Patches Applied',
      'translation.confidence': 'Confidence',
      'translation.no.patches': 'No patches applied yet.',
      'translation.quality.metrics': 'Translation Quality Metrics',
      'translation.translated.keys': 'Translated Keys',
      'translation.pending.review': 'Pending Review',
      'translation.recent.activity': 'Recent Translation Activity',
      'translation.auto.translated': 'Auto-translated',
      'translation.audit.completed': 'Translation Audit Completed',
      'translation.keys.scanned': 'keys scanned',
      'translation.audit.failed': 'Translation Audit Failed',
      'translation.healing.completed': 'Self-Healing Completed',
      'translation.keys.healed': 'keys healed',
      'translation.healing.failed': 'Self-Healing Failed',
