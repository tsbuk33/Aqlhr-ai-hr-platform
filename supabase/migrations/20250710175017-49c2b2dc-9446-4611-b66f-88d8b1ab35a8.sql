-- Fix RLS policies and seed company data properly with unique CR numbers
...
-- Create sample companies for testing with unique CR numbers
...
WHERE e.status = 'active' AND e.company_id IN ('11111111-1111-1111-1111-111111111111', '22222222-2222-2222-2222-222222222222', '33333333-3333-3333-3333-333333333333')
...
SELECT 
  ...
  'processed'
FROM employees e
WHERE e.status = 'active' AND e.basic_salary IS NOT NULL AND e.company_id IN ('11111111-1111-1111-1111-111111111111', '22222222-2222-2222-2222-222222222222', '33333333-3333-3333-3333-333333333333')
