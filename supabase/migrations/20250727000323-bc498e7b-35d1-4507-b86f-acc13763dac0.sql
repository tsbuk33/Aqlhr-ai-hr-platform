...
-- Insert pilot_group_users (using valid access_level values: viewer, reviewer, admin)
...
VALUES
  ...
  ('55555555-5555-5555-5555-555555555555', ARRAY['i18n_review'], 'viewer',   true, now() + interval '3 months');
