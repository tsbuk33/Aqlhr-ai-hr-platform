-- Fix the INSERT...RETURNING issue in dev_seed_employees_v1
...
begin
  ...
  -- Insert departments with codes (fix the RETURNING issue)
  ...
  -- Get all department IDs after insert
...
-- Create zero-arg wrapper with explicit call syntax
...
set search_path = public
as $$
  select public.dev_seed_retention_v1(null::uuid);
$$;