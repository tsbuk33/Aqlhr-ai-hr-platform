      ...
      <div className="container mx-auto px-6 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div>
            ...
            <p className="text-sm text-sidebar-foreground/80 mb-4 font-arabic">
          ...
          <div>
            <h4 className="text-sm font-semibold text-sidebar-foreground mb-4 font-saudi-heading">{isArabic ? 'تواصل معنا' : 'Contact'}</h4>
            <ul className="space-y-2 text-sm text-sidebar-foreground/80">
        ...
        <section className="mt-8 space-y-2">
          <h4 className="text-sm font-semibold text-sidebar-foreground/90 font-saudi-heading">
          ...
          <p className="text-xs text-sidebar-foreground/60 font-arabic">
