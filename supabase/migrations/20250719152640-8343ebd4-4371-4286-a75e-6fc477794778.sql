-- Create tables for LEO-GEO integration (Fixed)
...
CREATE TABLE public.engagement_metrics_tracking (
  ...
  created_at TIMESTAMP WITH TIME ZONE DEFAULT now(),
  updated_at TIMESTAMP WITH TIME ZONE DEFAULT now(),
  UNIQUE(employee_id, company_id, measurement_date)
);
...
-- Create simplified function to sync LEO-GEO data
...
('11111111-1111-1111-1111-111111111111', '22222222-2222-2222-2222-222222222222', 'AI & Machine Learning', 'Technical', 75, 90, 83, 12),
('11111111-1111-1111-1111-111111111111', '33333333-3333-3333-3333-333333333333', 'Cultural Intelligence', 'Cultural', 82, 95, 86, 8),
('11111111-1111-1111-1111-111111111111', '44444444-4444-4444-4444-444444444444', 'Digital Leadership', 'Leadership', 68, 85, 80, 5);
...
('11111111-1111-1111-1111-111111111111', '22222222-2222-2222-2222-222222222222', 87, 94, 5, 3, 8, 89),
('11111111-1111-1111-1111-111111111111', '33333333-3333-3333-3333-333333333333', 82, 88, 3, 7, 12, 91),
('11111111-1111-1111-1111-111111111111', '44444444-4444-4444-4444-444444444444', 78, 85, 8, 2, 6, 85);