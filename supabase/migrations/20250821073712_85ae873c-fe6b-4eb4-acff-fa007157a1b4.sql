...
drop policy if exists "tenant_rw_comp_settings" on public.compliance_settings;
drop policy if exists "tenant_rw_comp_letters" on public.compliance_letters;
drop policy if exists "tenant_rw_comp_runs" on public.compliance_runs;

-- Create new policies
create policy "tenant_rw_comp_settings" on public.compliance_settings
  for all using (tenant_id = get_user_company_id()) with check (tenant_id = get_user_company_id());
  
create policy "tenant_rw_comp_letters" on public.compliance_letters
  for all using (tenant_id = get_user_company_id()) with check (tenant_id = get_user_company_id());
  
create policy "tenant_rw_comp_runs" on public.compliance_runs
  for all using (tenant_id = get_user_company_id()) with check (tenant_id = get_user_company_id());
...
drop policy if exists "Compliance letters tenant read access" on storage.objects;
drop policy if exists "Compliance letters tenant write access" on storage.objects;
drop policy if exists "Compliance letters tenant update access" on storage.objects;
drop policy if exists "Compliance letters tenant delete access" on storage.objects;

-- Storage policies for compliance letters (private, admin/hr access only)
create policy "Compliance letters tenant read access"
...
create policy "Compliance letters tenant write access"
...
create policy "Compliance letters tenant update access"
...
create policy "Compliance letters tenant delete access"
