...
const bundles: Record<string, Bundle> = {
  ...
  tools: {
    en: {
      ...
      bulk_import_management: 'Bulk import monitoring and management',
      ...
      no_jobs: 'No import jobs found',
      no_errors: 'No error rows found',
      loading_jobs: 'Loading jobs...',
      loading_rows: 'Loading rows...',
      retry_success: 'Retry operation completed successfully',
      retry_error: 'Failed to retry operation',
      export_success: 'Error data exported successfully',
      all_jobs: 'All Jobs',
      failed_jobs: 'Failed Jobs',
      processing_jobs: 'Processing Jobs',
      completed_jobs: 'Completed Jobs',
      employees_mode: 'Employees',
      benefits_mode: 'Benefits',
      all_modes: 'All Modes'
    },
    ar: {
      // Import Center
      import_center: 'مركز الاستيراد',
      bulk_import_management: 'مراقبة وإدارة الاستيراد المجمع',
      import_jobs: 'مهام الاستيراد',
      job_details: 'تفاصيل المهمة',
      error_rows: 'الصفوف بأخطاء',
      retry_job: 'إعادة محاولة المهمة',
      retry_selected: 'إعادة محاولة المحدد',
      export_errors: 'تصدير الأخطاء',
      ...
      success_count: 'عدد النجاحات',
      job_id: 'معرف المهمة',
      row_index: 'فهرس الصف',
      error_message: 'رسالة الخطأ',
      raw_data: 'البيانات الأولية',
      select_all: 'تحديد الكل',
      no_jobs: 'لم يتم العثور على مهام استيراد',
      no_errors: 'لم يتم العثور على صفوف بأخطاء',
      loading_jobs: 'جاري تحميل المهام...',
      loading_rows: 'جاري تحميل الصفوف...',
      retry_success: 'تمت عملية إعادة المحاولة بنجاح',
      retry_error: 'فشل في إعادة المحاولة',
      export_success: 'تم تصدير بيانات الأخطاء بنجاح',
      all_jobs: 'جميع المهام',
      failed_jobs: 'المهام الفاشلة',
      processing_jobs: 'المهام قيد المعالجة',
      completed_jobs: 'المهام المكتملة',
      employees_mode: 'الموظفين',
      benefits_mode: 'المزايا',
      all_modes: 'جميع الأوضاع'
    }
  }
};
