...
function NonLocalizedRedirect() {
  ...
  const directRoutes = ['/dashboard', '/auth', '/system-overview'];
  ...
  // Root → send to system overview
  if (normalized === '/') {
    console.log('AqlHR: [UnifiedLanguageRouter] Redirecting root to system overview');
