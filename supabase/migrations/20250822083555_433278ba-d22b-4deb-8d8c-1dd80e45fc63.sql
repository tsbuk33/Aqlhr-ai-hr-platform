...
BEGIN
  ...
  SELECT COALESCE(AVG((answers->'psychological_safety')::numeric), 50) INTO v_cci_safety_score
...
BEGIN
  ...
  SELECT 
    ...
    CASE 
      WHEN ms.overload AND ms.span > 10 THEN ARRAY['SPAN_OVERLOAD', 'EXCESSIVE_SPAN']
      WHEN ms.overload THEN ARRAY['SPAN_OVERLOAD']
      WHEN ms.span > 10 THEN ARRAY['EXCESSIVE_SPAN']
      ELSE ARRAY[]::TEXT[]
    END as risk_factors,
